                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="yummyfood-nav">
                            <ul class="navbar-nav" id="yummy-nav">
							    ...
							    %>
							    		 <li class="nav-item">
                                   			<a class="nav-link" href="archive.jsp?b_num=<%=article.getB_num()%>"><%=article.getB_title() %></a> <!-- index.jsp 대신 데베에 저장된 게시판 jsp를 가져옴 -->
                           		 		</li>
						     	<%}%>
                            </ul>
                        </div>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">카테고리 이름</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="pagination-area d-sm-flex mt-15">
                        <nav aria-label="#">
                            <ul class="pagination">
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="#">다음페이지 <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                </li>
                            </ul>
                        </nav>
